...
import 'package:flutter_rope/bouncer.dart';
...
class _SpringState extends State<Spring> {
  ...
  void initState() {
    ...
    for (int i = 0; i < noOfParticles; i++) {
      ...
      if (i != 0) {
        ...
        var spring = Bouncer(a, b, k, restLength);
        _springs[i] = spring;
      }
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Flutter Rope physics Demo Home Page'),
        ),
